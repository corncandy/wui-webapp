...
export default class DataPaginator extends Component {
  nextPage () {
          ...
          <div className='col-sm-7'>
            <ul className='pagination pagination-sm pull-right' style={{margin: 0}}>
            {
              ...
              ? <li
                ...
                <a className={classes.paginator} style={{width: '34px', textAlign: 'center', cursor: 'pointer'}}>
            ...
            }
              {
                paginators.map((paginator, index) => (
                  <li
                    ...
                    <a className={classes.paginator} style={{width: '34px', textAlign: 'center', cursor: 'pointer'}}>{paginator + 1}</a>
                  </li>
                ))
              }
            {
...
DataPaginator.propTypes = {
  ...
  onSwitch: PropTypes.func.isRequred
}
